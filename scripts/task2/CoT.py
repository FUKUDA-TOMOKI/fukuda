...
if __name__ == "__main__":
    ...
    context = [
        [
            ...
            [
                ...
                "The main event featured a steel cage match between the teams of Heavy Metal and Blue Demon Jr. and Kick Boxer and Abismo Negro.",
    ...
    answer = main(user_question, context)
    print(answer)
